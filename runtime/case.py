...
class Case:
    ...
    reply_repairs: dict[str, int] = field(default_factory=dict)
    ...
    loop_metrics: dict[str, list[Any]] = field(default_factory=dict)
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "reply_repairs": self.reply_repairs,

...
不是讓 AI 自己聊，而是讓 AI 進入制度化治理。

如果你也受夠模糊需求、幻覺輸出、假裝完成，這個框架值得看。
...
- 行政權負責實作
- 司法權負責審查
- Harness 負責把所有驗證變成可重複測試

這不是一般的 Agent 聊天框架，而是可以拿來做專案、做 App、做需求驗證的制度化系統。
如果你想看 AI 怎麼從混亂變成可治理，歡迎直接到 GitHub 下載試玩。
